...
export const mockVendors: Vendor[] = [
  {
    slug: 'futur',
    name: 'Futur Store',
    logo: ecom('imgs/page/vendor/futur.webp'),
    cover: ecom('imgs/page/vendor/featured.webp'),
    products: 128,
    reviews: 65,
    memberSince: 2012,
  ...
  },
  {
    slug: 'elmado',
    name: 'Elmado Shop',
    logo: ecom('imgs/page/vendor/elmado.webp'),
    cover: ecom('imgs/page/vendor/featured.webp'),
    products: 96,
    reviews: 48,
    memberSince: 2014,
  ...
  },
  {
    slug: 'costctrl',
    name: 'Costctrl',
    logo: ecom('imgs/page/vendor/costctrl.webp'),
    cover: ecom('imgs/page/vendor/featured.webp'),
    products: 210,
    reviews: 112,
    memberSince: 2011,
  ...
  },
  {
    ...
    logo: ecom('imgs/page/vendor/fasfox.webp'),
    cover: ecom('imgs/page/vendor/featured.webp'),
    products: 360,
    reviews: 65,
    memberSince: 2012,
  ...
  },
  {
    slug: 'tropper',
    name: 'Tropper',
    logo: ecom('imgs/page/vendor/tropper.webp'),
    cover: ecom('imgs/page/vendor/featured.webp'),
    products: 74,
    reviews: 33,
    memberSince: 2016,
  ...
  },
  {
    slug: 'asembly',
    name: 'Asembly',
    logo: ecom('imgs/page/vendor/asembly.webp'),
    cover: ecom('imgs/page/vendor/featured.webp'),
    products: 152,
    reviews: 89,
    memberSince: 2013,
  ...
  },
  {
    slug: 'aslan',
    name: 'Aslan Tech',
    logo: ecom('imgs/page/vendor/aslan.webp'),
    cover: ecom('imgs/page/vendor/featured.webp'),
    products: 188,
    reviews: 77,
    memberSince: 2015,
  ...
  },
  {
    slug: 'market',
    name: 'Market Hub',
    logo: ecom('imgs/page/vendor/market.webp'),
    cover: ecom('imgs/page/vendor/featured.webp'),
    products: 245,
    reviews: 140,
    memberSince: 2010,
